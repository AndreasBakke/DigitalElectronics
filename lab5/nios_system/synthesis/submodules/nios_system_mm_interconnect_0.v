...
module nios_system_mm_interconnect_0 (
	...
	wire  [103:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_qsys_0_data_master_agent:rp_data
	...
	wire  [103:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> nios2_qsys_0_instruction_master_agent:rp_data
	...
	wire  [104:0] nios2_qsys_0_jtag_debug_module_agent_rf_source_data;                                // nios2_qsys_0_jtag_debug_module_agent:rf_source_data -> nios2_qsys_0_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [104:0] nios2_qsys_0_jtag_debug_module_agent_rsp_fifo_out_data;                             // nios2_qsys_0_jtag_debug_module_agent_rsp_fifo:out_data -> nios2_qsys_0_jtag_debug_module_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> nios2_qsys_0_jtag_debug_module_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                              // nios2_qsys_0_jtag_debug_module_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [7:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> nios2_qsys_0_jtag_debug_module_agent:cp_channel
	...
	wire  [103:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> KEYS_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // KEYS_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [7:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> KEYS_s1_agent:cp_channel
	...
	wire  [104:0] ledr_s1_agent_rf_source_data;                                                       // LEDR_s1_agent:rf_source_data -> LEDR_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] ledr_s1_agent_rsp_fifo_out_data;                                                    // LEDR_s1_agent_rsp_fifo:out_data -> LEDR_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> LEDR_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // LEDR_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> LEDR_s1_agent:cp_channel
	...
	wire  [103:0] nios2_qsys_0_data_master_agent_cp_data;                                             // nios2_qsys_0_data_master_agent:cp_data -> router:sink_data
	...
	wire  [103:0] nios2_qsys_0_instruction_master_agent_cp_data;                                      // nios2_qsys_0_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [103:0] performance_counter_0_control_slave_agent_rp_data;                                  // performance_counter_0_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [103:0] nios2_qsys_0_jtag_debug_module_agent_rp_data;                                       // nios2_qsys_0_jtag_debug_module_agent:rp_data -> router_004:sink_data
	...
	wire  [103:0] keys_s1_agent_rp_data;                                                              // KEYS_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [103:0] ledr_s1_agent_rp_data;                                                              // LEDR_s1_agent:rp_data -> router_007:sink_data
